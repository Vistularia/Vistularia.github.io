...
- Key Item
	- The Source Sanctum
		- Needs the Titan Codex to translate Giant Code
- Grand Plot
	- Integrate all the ancient power and giant technology into a new form of warforged that can fight the Banished, experimentation and a new adaptable race
 - Questions Answered
	 - What happened to all of the lost races?
	 - What happens in the Northern Wastelands?
  - Champion
	- Chioma
...
[[Berellius the Tainted]]
### Purpose
Destroy all the Mortal Life, accrue all the ancient power and start over with a new world


### Grand Plan
Forgotten Historia Arc
Berellius is the reason that the other races are missing.

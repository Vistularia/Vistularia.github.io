...
> # Item
> ![[Bahamuts Blade.png]]
> [[Bahamuts Blade.png|Expand Image]]
> ###### Stats
> Property |  Stats |
> ---|---|
> Type | ^^^ |
...
A blade that offers great protection

Has slots for spell storage for only protection and healing spells

Has a sliver of Bahamuts spirit

- Bahamuts Blade
	- Starts as a taxblade
	- Places of Sin
		- Gambling Casino
		- Crimson Guild Stronghold - Jimbasa
		- *** One More
